    ...
    function heartBeat() {
        ...
        xmlhttp.onreadystatechange = function () {
            if (xmlhttp.readyState === 4 && xmlhttp.status === 200 && xmlhttp.responseText !== "") {
                ...
                if(parseInt(json.roomPeoNum) !== peoNum){
                    peoNum = parseInt(json.roomPeoNum);
                    location.reload();
                }
            }
        }
                ...
                if (hostUser.equals(name)) {
                    ...
                    if (rsRoom.getInt("status") == 1) {
                        ...
                        if (rsHnum.getInt(1) == 0) {
                            ...
                            ps = conn.prepareStatement("SELECT * FROM dbhistory WHERE matchid = ? AND status=2 ORDER BY score DESC,usetime ASC;");
                            ps.setInt(1, rsRoom.getInt("nowMatch"));
